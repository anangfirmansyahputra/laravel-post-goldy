  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header d-flex justify-content-between">
        ...
        <button class="btn btn-primary" id="selectBranchButton">Select Branch</button>
      </div>
      <div class="row">
          ...
          <div class="modal-body form-group">
            ...
            <select class="form-control" name="branch" id="selectBranch">
              @foreach ($branchs as $branch)
                <option value="{{ $branch->id }}" @selected(request()->route('id') == $branch->id)>{{ $branch->name }}</option>
              @endforeach
            </select>
          </div>
...
@push('scripts')
  ...
  <script>
    $(document).ready(function() {
      $('#selectBranchButton').click(function() {
