  ...
  <div class="main-content">
    <section class="section">
      ...
      <div class="section-body">
        ...
        <div class="card">
          <form action="{{ route('products.update', ['id' => request()->route('id'), 'product' => $product->id]) }}"
            method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <select class="form-control selectric @error('branch_id') is-invalid @enderror" name="branch_id"
                  id="branch_id">
                  <option value="">Choose Branch</option>
                  @foreach ($branches as $branch)
                    <option value="{{ $branch->id }}" @if (old('branch_id', $product->branch_id) == $branch->id) selected @endif>
              ...
              <div class="form-group">
                ...
                <select class="form-control selectric @error('category_id') is-invalid @enderror" name="category_id"
                  ...
                  @foreach ($categories as $category)
                    <option value="{{ $category->id }}" data-fragrances="{{ $category->fragrances_status }}"
                      @if (old('category_id', $product->category_id) == $category->id) selected @endif>{{ $category->name }} -
                      {{ $category->fragrances_status == 1 ? 'Is Fragrances' : 'Is Not Fragrances' }}</option>
                  @endforeach
                </select>
                @error('category_id')
                  <div class="invalid-feedback">
              ...
              <div class="form-group" id="literContainer" style="@if (old('category_id', $product->category_id) != $product->category->fragrances_status) display: none; @endif">
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control @error('fragrances_name') is-invalid @enderror"
                      name="fragrances_name" value="{{ old('fragrances_name', $product->fragrance->name ?? '') }}">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control @error('concentration') is-invalid @enderror"
                      name="concentration" value="{{ old('concentration', $product->fragrance->concentration ?? '') }}">
                    @error('concentration')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('gram') is-invalid @enderror" name="gram"
                      value="{{ old('gram', $product->fragrance->gram ?? '') }}">
                    @error('gram')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('milliliter') is-invalid @enderror"
                      name="milliliter" value="{{ old('milliliter', $product->fragrance->mililiter ?? '') }}">
                    @error('milliliter')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('pump_weight') is-invalid @enderror"
                      name="pump_weight" value="{{ old('pump_weight', $product->fragrance->pump_weight ?? '') }}">
                    @error('pump_weight')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('bottle_weight') is-invalid @enderror"
                      name="bottle_weight"
                      value="{{ old('bottle_weight', $product->fragrance->bottle_weight ?? '') }}">
                    @error('bottle_weight')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
