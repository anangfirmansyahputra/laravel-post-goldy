                        ...
                        <div class="form-group" id="literContainer" style="@if(old('category_id', $product->category_id) != $product->category->fragrances_status) display: none; @endif">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control @error('concentration') is-invalid @enderror" name="concentration" value="{{ old('concentration', $product->fragrance->concentration ?? '') }}">
                                    @error('concentration')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control @error('gram') is-invalid @enderror" name="gram" value="{{ old('gram', $product->fragrance->gram ?? '') }}">
                                    @error('gram')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control @error('milliliter') is-invalid @enderror" name="milliliter" value="{{ old('milliliter', $product->fragrance->mililiter ?? '') }}">
                                    @error('milliliter')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control @error('pump_weight') is-invalid @enderror" name="pump_weight" value="{{ old('pump_weight', $product->fragrance->pump_weight ?? '') }}">
                                    @error('pump_weight')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control @error('bottle_weight') is-invalid @enderror" name="bottle_weight" value="{{ old('bottle_weight', $product->fragrance->bottle_weight ?? '') }}">
                                    @error('bottle_weight')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
