  ...
  <div class="main-content">
    <section class="section">
      ...
      <div class="section-body">
        ...
        <div class="card">
          <form action="{{ route('products.store', ['id' => request()->route('id')]) }}" method="POST"
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control @error('fragrances_name') is-invalid @enderror"
                      name="fragrances_name" value="{{ old('fragrances_name') }}">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control @error('concentration') is-invalid @enderror"
                      name="concentration" value="{{ old('concentration') }}">
                    @error('concentration')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('milliliter') is-invalid @enderror"
                      name="milliliter" value="{{ old('milliliter') }}">
                    @error('milliliter')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('pump_weight') is-invalid @enderror"
                      name="pump_weight" value="{{ old('pump_weight') }}">
                    @error('pump_weight')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control @error('bottle_weight') is-invalid @enderror"
                      name="bottle_weight" value="{{ old('bottle_weight') }}">
                    @error('bottle_weight')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
